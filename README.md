1.  Eyeball MSSIPLibrary v10.0 Developer Reference Guide 2

    1.  [1. Introduction 2](#_bookmark1)

        1.  [1.1. Supported Platforms and Features 2](#_bookmark2)

        2.  [1.2. Programming Conventions 3](#_bookmark3)

    2.  [2. Supported Standards 3](#_bookmark4)

    3.  [3. Using Eyeball MS-SIP Library 4](#_bookmark5)

        1.  [3.1. Creating the Main Objects 4](#_bookmark6)

        2.  [3.2. Using the Features and Functions 4](#_bookmark7)

        3.  [3.3. Handling Event Notifications 5](#_bookmark8)

    4.  [4. Eyeball MS-SIP: APIs 6](#_bookmark9)

        1.  [4.1 MS-SIP Methods 6](#_bookmark10)

        2.  [4.2 MS-SIP Notification Events 23](#_bookmark11)

    5.  [5. Legal and Contact Information 33](#_bookmark12)
